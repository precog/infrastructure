...
run_list "recipe[nginx::repo]", "recipe[nginx]", "recipe[precog::staticsite]", "recipe[precog::blogredirect]", "recipe[precog::reportgridredirect]", "recipe[precog::developersredirect]"
